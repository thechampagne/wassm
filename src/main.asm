...
ip_address:
    db "0.0.0.0", 0
server_addr sockaddr_in AF_INET, 0, 0, 0
client_addr sockaddr_in 0, 0, 0, 0
client_addr_size:
    dd 16
...
;;; port = htons(server_addr.sin_port)
    mov rdi, [port]
    call htons
    mov [server_addr + sockaddr_in.sin_port], ax ; mov [server_addr + sockaddr_in.sin_port], rax
;;; ---
...
;;; printf(html_served_message, inet_ntoa(client_addr.sin_addr))
    mov edi, [client_addr + sockaddr_in.sin_addr] ; mov rdi, [client_addr + sockaddr_in.sin_addr]
    call inet_ntoa
